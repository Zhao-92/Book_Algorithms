...
pathSc = '/Users/ponycc/Study/gupiao/all.csv'    # 存储所有股票相关信息
pathRt = '/Users/ponycc/Study/gupiao/result.csv'   # 存储筛选后的相关股票
pathSingle = '/Users/ponycc/Study/gupiao/single/'  # 存储每只股票相关信息
